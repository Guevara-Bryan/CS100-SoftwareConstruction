#ifndef SELECTIONVECTORTESTS_HPP
#define SELECTIONVECTORTESTS_HPP
...
TEST(SelectionsortTestSet, SelectionSortTest1)
{
    Op* seven = new Op(7);
    Op* four = new Op(4);
...
TEST(SelectionsortTestSet, SelectionSortTest2)
{
    Op* seven = new Op(7);
    Op* four = new Op(4);
    Mult* TreeA = new Mult(seven, four);
...
TEST(SelectionsortTestSet, SelectionSortTest3)
{
    Op* seven = new Op(7);
    Op* four = new Op(4);
    Mult* TreeA = new Mult(seven, four);
